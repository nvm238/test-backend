...
public class UserView implements Serializable {
    ...
    public UserView(UserView value) {
        this.id = value.id;
        ...
        this.labelPublicId = value.labelPublicId;
    ...
    public UUID getLabelPublicId() {
        return this.labelPublicId;
    }

    /**
     * Setter for <code>public.user_view.label_public_id</code>.
     */
    public void setLabelPublicId(UUID labelPublicId) {
        this.labelPublicId = labelPublicId;
    }
    ...
    public String toString() {
        ...
        sb.append(", ").append(labelPublicId);
